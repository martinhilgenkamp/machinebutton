...
void registerMachine() {
  ...
  // Static URL or Dynamic EEPROM URL
//String URL = "http://192.168.111.151/vanda/pages/api/api.php";
...
void setup() {
  ...
  Serial.begin(115200);
  Serial.println("Systeem word opgestart.");

  // Turn off LED
  digitalWrite(LED, HIGH);
  
  // Loading Wifi Setup from EEPPROM
